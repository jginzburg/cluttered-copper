...
----
$ git clone git@github.com:jginzburg/cluttered-copper
...
You can interact with the example application using the form at the secured endpoint URL and the link:https://access.redhat.com/documentation/en-us/red_hat_support_for_spring_boot/#rhsso-realm-model_secured[provided users].
